...
customerNames = ['Pavan', 'Hemanth', 'Manoj', 'Dharmendra', 'Padmavathi', 'Raasi', 'Aishwarya', 'Suresh', 'Ramesh', 'Neha','Vijay', 'Anusha', 
                 'Kiran', 'Pooja', 'Arjun', 'Sandeep', 'Shweta', 'Sanjay', 'Nandini', 'Prakash','Deepak', 'Akash', 'Vinay', 'Divya', 'Satish',
                 'Rajesh', 'Meena', 'Rohit', 'Shivani', 'Anand','Nehal', 'Geeta', 'Prasad', 'Bhavna', 'Amit', 'Aruna', 'Rohini', 'Rajeev', 
                 'Jyoti','Vivek','Smita', 'Raj', 'Priya', 'Arun', 'Preeti', 'Nitin', 'Kavita', 'Rajat', 'Swati']
customerPins = ['0123', '2575', '7275', '2312', '5049', '9876', '5432', '4567', '1357', '2468','7890', '6543', '5436', '1235', '9584', '7431', 
                '3698', '9874', '1345', '7893','5678', '8901', '3456', '7895', '4563', '1267', '8463', '9753', '7641', '8745','9632', '8246', 
                '3579', '6842', '3495', '2798', '6294', '1593', '7391', '5862','3958', '2467', '5367', '9271', '8475', '3256', '7532', '4619', 
                '8173', '9582']
customerBalances = [40000, 60000, 30000, 100000, 110000, 80000, 55000, 67000, 43000, 92000,75000, 48000, 63000, 72000, 56000, 89000, 45000, 68000, 
                    55000, 95000, 42000, 89000, 57000, 71000, 66000, 54000, 88000, 63000, 71000, 49000,72000, 85000, 59000, 46000, 82000, 69000, 
                    57000, 93000, 72000, 60000,248000, 54000, 83000, 46000, 67000, 59000, 78000, 64000, 59000, 52000]
    ...
    if choiceNumber == "1":
        ...
        if i > 5:
            ...
            while counter_1 <= i:
                ...
                # Ask the user if they want to generate a pin or input their own
                generate_option = input("Do you want to generate a PIN? (yes/no): ").lower()
